...
- **Reactivate "At Risk" Customers**: This group has high recency and requires immediate attention. Confirmed by (https://github.com/bitsbard/customer-retention-t-test)[t-test-1]
